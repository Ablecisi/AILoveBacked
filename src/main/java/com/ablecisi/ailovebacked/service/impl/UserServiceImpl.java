...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(UserMapper userMapper, PostMapping postMapping, PostLikeRelationMapper postLikeRelationMapper, JwtProperties jwtProperties) {
        this.userMapper = userMapper;
        this.postMapping = postMapping;
        this.postLikeRelationMapper = postLikeRelationMapper;
    ...
    public UserVO login(UserDTO userDTO) {
        ...
        return UserVO.builder()
                ...
                .token(token) // 模拟的token，实际应用中应使用JWT或其他方式生成
                .postIds(postIds)
                .isFollowed(false) // 模拟的关注状态，实际应用中应根据用户关系表查询
